package com.jeecg.customer.service.impl;
...
public class CustomerServiceImpl extends CommonServiceImpl implements CustomerServiceI {
	...
	private void doDelBus(CustomerEntity t) throws Exception{
 	...
 	private Map<String,Object> populationMap(CustomerEntity t){
		...
		map.put("rental", t.getRental());
		map.put("property_manage_fee", t.getPropertyManageFee());
		map.put("water", t.getWater());
		map.put("electricity", t.getElectricity());
	 ...
	 */
 	public String replaceVal(String sql,CustomerEntity t){
 		...
 		sql  = sql.replace("#{rental}",String.valueOf(t.getRental()));
 		sql  = sql.replace("#{property_manage_fee}",String.valueOf(t.getPropertyManageFee()));
 		sql  = sql.replace("#{water}",String.valueOf(t.getWater()));
 		sql  = sql.replace("#{electricity}",String.valueOf(t.getElectricity()));
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("e_customer",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
