package com.jeecg.customer.controller;
...
import com.jeecg.customer.service.CustomerServiceI;
...
public class CustomerController extends BaseController {
	...
	public ModelAndView list(HttpServletRequest request) {
		return new ModelAndView("com/jeecg/customer/customerList");
	}
	...
	public ModelAndView goAdd(CustomerEntity customer, HttpServletRequest req) {
		...
		return new ModelAndView("com/jeecg/customer/customer-add");
	}
	/**
	 * 客户编辑页面跳转
	 * 
	...
	public ModelAndView goUpdate(CustomerEntity customer, HttpServletRequest req) {
		...
		return new ModelAndView("com/jeecg/customer/customer-update");
	}
