...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="customerController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
									  ...
									  ignore="ignore"
									    value='<fmt:formatDate value='${customerPage.createDate}' type="date" pattern="yyyy-MM-dd"/>'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="rental" name="rental" type="text" style="width: 150px" class="inputxt"  datatype="n" 
						     	 ignore="ignore" 
						     	 value='${customerPage.rental}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="propertyManageFee" name="propertyManageFee" type="text" style="width: 150px" class="inputxt"  datatype="n" 
						     	 ignore="ignore" 
						     	 value='${customerPage.propertyManageFee}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="water" name="water" type="text" style="width: 150px" class="inputxt"  datatype="n" 
						     	 ignore="ignore" 
						     	 value='${customerPage.water}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="electricity" name="electricity" type="text" style="width: 150px" class="inputxt"  datatype="n" 
						     	 ignore="ignore" 
						     	 value='${customerPage.electricity}'>
							<span class="Validform_checktip"></span>
